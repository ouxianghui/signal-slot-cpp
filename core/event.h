...
#define RTC_DISALLOW_WAIT()
    ...
    public:
        ...
        static constexpr core::TimeDelta kForever =
            core::TimeDelta::PlusInfinity();
        ...
        void Reset();
               ...
               // some other error.
        bool Wait(core::TimeDelta give_up_after, core::TimeDelta warn_after);

               // Waits with the given timeout and a reasonable default warning timeout.
        bool Wait(core::TimeDelta give_up_after) {
            return Wait(give_up_after, give_up_after.IsPlusInfinity()
                                           ? core::TimeDelta::Seconds(3)
                                           : kForever);
        }
