...
namespace core {
    ...
    namespace {
        ...
        public:
            ...
            static void SyncWithNtp(int64_t ntp_server_time_ms) {
                ...
                int64_t time_zone_bias_ns =
                    core::dchecked_cast<int64_t>(time_zone.Bias) * 60 * 1000 * 1000 * 1000;
            ...
            static int64_t TicksNs() {
                ...
                result = core::dchecked_cast<int64_t>(
                    (core::dchecked_cast<uint64_t>(qpcnt.QuadPart) * 100000 /
                     core::dchecked_cast<uint64_t>(singleton.os_ticks_per_second_)) *
                    10000);
        ...
        private:
            ...
            void UpdateReferenceTime() {
                ...
                os_ticks_per_second_ = core::dchecked_cast<int64_t>(qpfreq.QuadPart);

                LARGE_INTEGER qpcnt;
                QueryPerformanceCounter(&qpcnt);
                time_since_os_start_ns_ = core::dchecked_cast<int64_t>(
                    (core::dchecked_cast<uint64_t>(qpcnt.QuadPart) * 100000 /
                     core::dchecked_cast<uint64_t>(os_ticks_per_second_)) *
                    10000);
            }
    ...
    int64_t TimeUTCMicros() {
        ...
        return (static_cast<int64_t>(time.time) * core::kNumMicrosecsPerSec +
                static_cast<int64_t>(time.millitm) * core::kNumMicrosecsPerMillisec);
#endif
    }
